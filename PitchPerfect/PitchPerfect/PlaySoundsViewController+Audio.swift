...
extension PlaySoundsViewController: AVAudioPlayerDelegate {
    ...
    func setupAudio() {
        ...
        do {
            ...
            showAlert(RecordAlerts.AudioFileError, message: String(describing: error))
        }
    }
    ...
    func playSound(rate: Float? = nil, pitch: Float? = nil, echo: Bool = false, reverb: Bool = false) {
        ...
        do {
            ...
            showAlert(RecordAlerts.AudioEngineError, message: String(describing: error))
            return
        }
    ...
    func showAlert(_ title: String, message: String) {
        ...
        alert.addAction(UIAlertAction(title: RecordAlerts.DismissAlert, style: .default, handler: nil))
